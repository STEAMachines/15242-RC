...
public final class TankDrive {
    ...
    public final List<DcMotorEx> leftDrive, rightDrive;
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftDrive = Arrays.asList(hardwareMap.get(DcMotorEx.class, "leftDrive"));
        rightDrive = Arrays.asList(hardwareMap.get(DcMotorEx.class, "rightDrive"));
